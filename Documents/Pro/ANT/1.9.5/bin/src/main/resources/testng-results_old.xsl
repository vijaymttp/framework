	...
	<xsl:template name="writeJsFile">
		<xsl:result-document href="{testng:absolutePath('main.js')}"
            ...
            function filterMethods(filterCheckBox, status) {
                var all =document.getElementById("methodsFilter_ALL").checked;
				var pass=document.getElementById("methodsFilter_PASS").checked;
				var fail=document.getElementById("methodsFilter_FAIL").checked;
				var skip=document.getElementById("methodsFilter_SKIP").checked;
				if(all){
				document.getElementById('testMethodsByStatus').style.display="";
				document.getElementById('passCases').style.display="none";
				document.getElementById('failCases').style.display="none";
				document.getElementById('skipCases').style.display="none";
				
				}
			else if(pass&&fail){
			document.getElementById('testMethodsByStatus').style.display="none";			
				document.getElementById('passCases').style.display="";
				document.getElementById('failMethodRow').style.display="none";
				document.getElementById('failCases').style.display="";
				document.getElementById('skipCases').style.display="none";
				}
				else if(pass&&skip){
			document.getElementById('testMethodsByStatus').style.display="none";
			document.getElementById('passCases').style.display="";
			document.getElementById('failCases').style.display="none";
			document.getElementById('skipMethodRow').style.display="none";
			document.getElementById('skipCases').style.display="";
			...
			document.getElementById('testMethodsByStatus').style.display="none";
				document.getElementById('passCases').style.display="none";
				document.getElementById('failMethodRow').style.display="";
				document.getElementById('failCases').style.display="";
				document.getElementById('skipMethodRow').style.display="none";
				document.getElementById('skipCases').style.display="";
				}
				...
				document.getElementById('passCases').style.display="none";
				document.getElementById('failCases').style.display="none";
			  document.getElementById('skipMethodRow').style.display="";
				document.getElementById('skipCases').style.display="";
				}
				else if(fail&&pass&&skip){
				document.getElementById('testMethodsByStatus').style.display="none";
				document.getElementById('passCases').style.display="";
				document.getElementById('failMethodRow').style.display="none";
				document.getElementById('failCases').style.display="";
        ...
        <xsl:result-document href="{testng:absolutePath('overview-chart.svg')}" format="xml">
            <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" width="{$chartWidth}" height="{$chartHeight}"
                ...
                <svg id="graphzone" preserveAspectRatio="xMidYMid meet" x="0" y="0">
                    ...
                    <rect style="fill:green;stroke-width:1;stroke:black;" x="10" y="86" width="20" height="20"/>
                    <text class="legendtext" x="40" y="105">Passed (<xsl:value-of select="$passPercent"/>)
                    </text>
					 <rect style="fill:red;stroke-width:1;stroke:black;" x="10" y="125" width="20" height="20"/>
                    <text class="legendtext" x="40" y="143">Failed (<xsl:value-of select="$failedPercent"/>)
                    </text>
...
<!-- create html  file for mailing purpose -->
...
table, tr, td {
    ...
    border-collapse: collapse;
               ...
               <xsl:call-template name="overHead"/>
                <body>
				<center>
				
			
                    <h1 style="font-family:'Times New Roman,serif';">Tesla Execution Report 
					</h1>
					</center>
					<img src="Tesla.png" alt="Tesla logo" width="80" height="65" align="left" style="position: absolute; top: 1; left: 25;  text-align:left;"/>
				<div style="position: absolute; top: 150; right: 450;">
				
					<xsl:call-template name="completeReport"/>
                    </div>
					<table width="100%" style="border-style: none;">
                        <tr style="border-style: none;">
                            <td align="center" id="chart-container" style="border-style: none;">
                                 <img id="User_Image" src="overview-chart.jpg" alt="A Pie chart should be displayed" style="border-width:1px;border-style:solid;height: 300; width: 600; border-style: none; top: 37px; left: 582px;" align="middle"/>     
                            </td>
                        </tr>
                    </table>
...
<b style="font-size: 20px;font-family:'Times New Roman';">Instance :  <xsl:value-of select="$testCaseElements[1]/class[1]/test-method[1]/params/param[@index='2']/value[1]"/> </b>
</td>
<td style="border-style: none;">
<b style="padding: 3px 3px 3px 35px; font-size: 20px;font-family:'Times New Roman';">Time:  <xsl:value-of  select="format-dateTime(current-dateTime(), '[h].[m01][Pn]')"/> </b>
</td>

<td style="border-style: none;" >
<b style="padding: 3px 3px 3px 35px; font-size: 20px;font-family:'Times New Roman';">Date:  <xsl:value-of  select="format-dateTime(current-dateTime(), '[D01]-[M01]-[Y1]')"/> </b>
</td>
</tr>
</table>           
		   <table width="100%" cellpadding="5" cellspacing="1" style="border: 1px solid black;">
						<tr style="background-color:#F0F0F0; border: 1px solid black;font-family:'Times New Roman,serif';">
						
						 <td width="100%" style="font-size: 18px;">
                                <b style="font-family:'Times New Roman,serif';"> <xsl:value-of select="@name"/>  Automation</b>
								
                                </td>
								  <td align="center" style="font-weight: bold; padding: 3px 15px 3px 0;">
								  <b style="font-family:'Times New Roman,serif';">
	  Total Count
	  </b>
	  </td>
								 <td style="padding: 3px 3px 3px 0; " align="center"><b style="font-family:'Times New Roman,serif';">
	Passed
	</b>
	</td>
						   <td style="padding: 3px 3px 5px 0; text-align: center;" align="right">
		<b style="font-family:'Times New Roman,serif';">			Failed</b>
   </td>
   
	<td style="padding: 3px 3px 3px 0;" align="center">
	<b style="font-family:'Times New Roman,serif';">Skipped</b>
	</td>
	
	  <td align="center" style="font-weight: bold; padding: 3px 5px 3px 0;font-family:'Times New Roman,serif';">
	  Pass%
	  </td>
	   <td align="center" style="font-weight: bold; padding: 3px 5px 3px 0;font-family:'Times New Roman,serif';">
	  Fail%
	  ...
	  Execution Time
                            ...
                            <xsl:for-each select="$testCaseElements">
                                <tr style="background-color:#F0F0F0; font-size: 14px; border: 1px solid black; border-collapse: collapse;font-family:'Times New Roman,serif';">
                                    <td style="font-size: 18px; font-family:'Times New Roman,serif';">
									
                                      <xsl:value-of select="@name"/>
									  
									
                                    </td>
									   <td align="center" style="font-family:'Times New Roman,serif';">
                                    ...
                                    <td align="center" style="font-weight: bold;font-family:'Times New Roman,serif';">
                                        <xsl:value-of
									...
									<td align="center" style="font-weight: bold;font-family:'Times New Roman,serif';">
                                        <xsl:value-of
                                                select="if (testng:testCaseMethodsCount(., '*') > 0) then format-number(testng:testCaseMethodsCount(., 'FAIL') div testng:testCaseMethodsCount(., '*'), '###%') else '100%'"/>
                                    </td>
							...
							<tr style="background-color: #989898 ; border: 1px solid black;  border-collapse: collapse;font-family:'Times New Roman,serif';">
                                <td width="100%" style="font-size: 18px;">
                                    <div class="{testng:suiteStateClass($testCaseElements)}"/>
                                 <b style="font-family:'Times New Roman,serif';">Total</b>
                                </td>
                                <xsl:call-template name="percentageOverviewMail">
...
<b style="padding: 3px 3px 3px 35px; font-size: 20px;font-family:'Times New Roman';">Date:  <xsl:value-of  select="format-dateTime(current-dateTime(), '[D01]-[M01]-[Y1]')"/> </b>
						...
						<tr style="background-color:#F0F0F0; border: 1px solid black;font-family:'Times New Roman,serif';">
						 ...
						 <td width="100%"  style="font-size: 18px;font-family:'Times New Roman,serif';">
                                <b> <xsl:value-of select="@name"/> Automation </b>
                                </td>
								 <td align="center" style="font-weight: bold;  padding: 3px 3px 3px 0;font-family:'Times New Roman,serif';" >
	  Total Count
	  </td>
	   <td style=" padding: 3px 3px 3px 0; " align="center">
	<b style="font-family:'Times New Roman,serif';">Passed</b>
	</td>
						   <td style="padding: 3px 3px 3px 0;" align="center">
						 <b style="font-family:'Times New Roman,serif';">  Failed</b>
   </td>
	...
	<b style="font-family:'Times New Roman,serif';">Skipped</b>
	  ...
	  Execution Time
							...
							<xsl:variable name="testCaseName" select="@name"/>
                              ...
                              <td style="font-size: 18px;font-family:'Times New Roman,serif';">
								<a href="{$suiteName}_{$testCaseName}.html">
				                 <xsl:value-of select="@name"/>
							</a>
                                    ...
                                    <xsl:if test="compare($testNgXslt.showRuntimeTotals, 'true') = 0">
                                        <td align="center" nowrap="true" style="font-family:'Times New Roman,serif';">
                                            <xsl:value-of select="testng:formatDuration(./@duration-ms)"/>
                                        </td>
                                    </xsl:if>
                                </tr>
        ...
        <xsl:result-document href="{testng:absolutePath('reporterOutput.html')}" format="xhtml">
            <html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <body>
                    <h2>Modules</h2>
                    <xsl:for-each select="Modules/line">
                        <div>
                            <code>
                                <xsl:value-of select="."/>
                            </code>
        ...
        <xsl:result-document href="{testng:absolutePath('navigation.html')}" format="xhtml">
            <html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <body>
					...
					<div>
<b>                       
					   <a  href="overview.html" target="content" style="font-size: 16px; padding: 40px 0 0 0;"
            ...
            <html>
                ...
                <body>
                    ...
                    <xsl:call-template name="testMethods">
                        ...
                        <xsl:with-param name="failedMethods" select="$testCaseElements/class/test-method[1][@status='FAIL']"/>
                        <xsl:with-param name="passedMethods" select="$testCaseElements/class/test-method[1][@status='PASS']"/>
                        <xsl:with-param name="skipedMethods" select="$testCaseElements/class/test-method[1][@status='SKIP']"/>
                    </xsl:call-template>
...
<xsl:with-param name="sortByStartTime" select="'true'"/>
		...
		<!--display methods list of pass status-->
	
		 <div id="passCases" style="display:none;">
            <xsl:if test="testng:isFilterSelected('BY_CLASS') = 'true'">
                <xsl:attribute name="style" select="'display: none;'"/>
            </xsl:if>
            <table class="testMethodsTable" cellpadding="0" cellspacing="0">
		...
		<!--display methods list of fail status-->
		 <div id="failCases" style="display:none;">
            <xsl:if test="testng:isFilterSelected('BY_CLASS') = 'true'">
                <xsl:attribute name="style" select="'display: none;'"/>
            </xsl:if>
            <table class="testMethodsTable" cellpadding="0" cellspacing="0">
                <tr id="failMethodRow" class="methodsTableHeader">
		...
		<!--display methods list of skip status-->
			 <div id="skipCases" style="display:none;">
            <xsl:if test="testng:isFilterSelected('BY_CLASS') = 'true'">
                <xsl:attribute name="style" select="'display: none;'"/>
            </xsl:if>
            <table class="testMethodsTable" cellpadding="0" cellspacing="0">
                <tr id="skipMethodRow" class="methodsTableHeader">
    ...
    <xsl:template name="testMethodsList">
        ...
        <xsl:for-each select="$methodList">
			...
			<xsl:variable name="ReportHTML" select="concat($CaseName[3],'.html')"/>
            <tr id="{concat($methodId, '_row')}" class="{testng:testMethodStatus(.)}">
                ...
                <td width="100%" class="firstMethodCell">
                    <a onclick="toggleDetailsVisibility('{$exceptionDetailsId}')">
                        <xsl:value-of select="$CaseName[3]"/>
                    </a>
                </td>
                <td nowrap="true">
				 ...
				 <td nowrap="true">
                    <xsl:value-of select="substring(@finished-at, 12, 8)"/>
                </td>
                ...
                <td nowrap="true">
                        <a onclick="toggleDetailsVisibility('{$exceptionDetailsId}')">
                            <xsl:value-of select="'Click here for more details'"/>
                        </a>
                    &#160;
                </td>
            </tr>
    ...
    <xsl:template name="suiteTestCasesLinks">
        ...
        <xsl:for-each select="$testCases">
            ...
            <div class="testCaseLink"
                ...
                <font style="font-size: 14px;font-family:'Times New Roman,serif';"><xsl:value-of select="@name"/></font>
            </div>
        </xsl:for-each>
    </xsl:template>
        ...
        <xsl:for-each select="$testCases">
            <xsl:result-document href="{testng:absolutePath(testng:testCaseContentFileName(.))}" format="xhtml">
                <html>
                    <xsl:call-template name="htmlHead"/>
                    <body>
                        <table width="80%" style="font-size: 16px; margin-bottom: 10px; margin-top: 20px; margin-left: 70px; border-style:double;" cellspacing="1">
                            <tr>
                                <td style="font-weight: bold; padding: 3px 5px 3px 0;font-family:'Times New Roman,serif';" align="center">
                                 Module    
                                </td>
								 <td align="center" style="font-weight: bold; padding: 3px 5px 3px 0;font-family:'Times New Roman,serif';">
	 Total Count
    ...
    Execution Time
	  ...
	  <tr>
	  <td align="center" style="background-color: #eaf0f7; padding: 3px 3px 3px 0;font-family:'Times New Roman,serif';font-size: 14px;">
                        ...
                        <xsl:call-template name="testMethods">
                            ...
                            <xsl:with-param name="failedMethods" select="./class/test-method[1][@status='FAIL']"/>
                            <xsl:with-param name="passedMethods" select="./class/test-method[1][@status='PASS']"/>
                            <xsl:with-param name="skipedMethods" select="./class/test-method[1][@status='SKIP']"/>
                        </xsl:call-template>
    ...
    <xsl:template name="percentageOverview">
		...
		<td align="center" style="background-color: #eaf0f7; padding: 3px 3px 3px 0;">
            <div style="width: 50px;">
                <xsl:value-of
                        select="if ($totalCount > 0) then format-number($failedCount div $totalCount, '###%') else '100%'"/>
            </div>
			</td>
        <xsl:if test="compare($testNgXslt.showRuntimeTotals, 'true') = 0">
	    ...
	    <xsl:template name="percentageOverviewMail">
            <xsl:param name="totalCount"/>
        <xsl:param name="passedCount"/>
		<xsl:param name="failedCount"/>
        <xsl:param name="skippedCount"/>
   ...
   <td align="center" style="padding: 3px 3px 3px 0;">
            <div style="width: 50px;font-family:'Times New Roman,serif';">
                <xsl:value-of select="$totalCount"/>
            </div>
        </td>
  <td style="padding: 3px 3px 3px 0;" align="center">
	   ...
	   <td style="padding: 3px 3px 3px 0;" align="center">
        ...
        <xsl:if test="compare($testNgXslt.showRuntimeTotals, 'true') = 0">
            <td style="padding: 3px 3px 3px 0;" align="center" nowrap="true">
                <xsl:value-of select="$totalDuration"/>
            </td>
        </xsl:if>
    </xsl:template>
	...
	<xsl:template name="completeReport">
        ...
        <div style="margin-top: 16px; color:0066FF; text-align: center; font-size: 18px;">
            <a href="{$fullReport}" style="color: black;" target="_blank">
             <font style="color:0066FF;font-family:'Times New Roman,serif';"> Click here to view detailed Report</font>
            </a>
        </div>
