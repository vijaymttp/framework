...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 xmlns:math="http://exslt.org/math" xmlns:testng="http://testng.org" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<body bgcolor="#C0C0C0">
	<img src="logo.png" alt="logo" width="160" height="30" align="left" style="position: absolute; top: 1; left: 25;  text-align:left;"/>
...
<!-- <TD style="font-size: 14px; font-family:'Calibri';">
	<xsl:value-of select="./params/param[@index='0']/value[1]"/>
	 ...
	 <xsl:result-document href="/Users/IT-Satya/Desktop/workspace/JDSportsScottsAndroidNativeApp/ANT/1.9.5/libexec/bin/test/runtime-totals/output/mail.html" format="xhtml">
...
<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
	...
	<!--bgcolor="#B8B8B8"-->
	<body bgcolor="#C0C0C0">
	<img src="logo.png" alt="logo" width="220" height="30" align="left" style="position: absolute; top: 1; left: 25;  text-align:left;"/>
	<!--<table id="myTestCasetable" border="1" style="border-style: none;"><tr style="border-style: none;">
	<td  style="border-style: none;">
	</td>
