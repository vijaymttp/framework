            ...
            <html xmlns="http://www.w3.org/1999/xhtml">
               <xsl:call-template name="overHead"/>
				...
				<center>
                    ...
                    <h1>SFDC Execution Report on <xsl:value-of  select="format-dateTime(current-dateTime(), '[h].[m01][Pn]  [FNn], [D1o] [MNn]')"/>
					</h1>
					</center>
                    <table width="100%">
                        <tr>
            ...
            <tr id="{concat($methodId, '_row')}" class="{testng:testMethodStatus(.)}">
                ...
                <td nowrap="true">
                        <a onclick="toggleDetailsVisibility('{$exceptionDetailsId}')">
                            <xsl:value-of select="'Please click here for more details'"/>
                        </a>
                    &#160;
                </td>
            </tr>
